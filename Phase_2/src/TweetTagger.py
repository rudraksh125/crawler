...
with open("../../data/f_hashtag_prediction/train_data_combined_20K_to_500K.txt", "a") as output_combined_file:
    with open("../../data/f_hashtag_prediction/train_data_tweets_processed_20K_to_500K.txt", "a") as output_file:
        with open("../../data/f_hashtag_prediction/train_data_tweets_tagged_20_to_500K.txt", "rb") as input_file:
